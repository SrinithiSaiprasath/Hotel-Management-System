...
cur.execute("""create table if not exists paymentsf(id number  primary key,f_name varchar,l_name varchar,c_number varchar,email varchar , r_n number ,day varchar,
...
Label(sroot,text="Srinithi Saiprasath",font='Timesnewroman 40 ',bg='white',fg='grey').place(x=535,y=180)
Label(sroot,text="scsrinithi@gmail.com",font='Timesnewroman 40',bg='white',fg='grey').place(x=535,y=270)
...
def mainroot():
	...
	root.title("Made with love by Srinithi")
	#--------------seperator-------------------------------------------------------------------------------------------------------------------
...
'''
	...
	def staff():
		...
		Label(emp1inf,text="Ms.Srinithi Saiprasath",bg='white',fg="Grey",font='msserif 10').place(x=60,y=37)
		...
		Label(emp1inf,text="Ms.POOJA ",bg='white',fg="Grey",font='msserif 10').place(x=45,y=37)
		Label(emp1inf,text="Extention : 032",bg='white',fg="Grey",font='msserif 10').place(x=45,y=59)
		Label(emp1inf,text="Mail : CUSTEXE@hotelname.com",bg='white',fg="Grey",font='msserif 10').place(x=45,y=83)	
		emp1inf.pack_propagate(False)
		...
		Label(emp1inf,text="Mr. ABI (Head)",bg='white',fg="Grey",font='msserif 10').place(x=72,y=37)
		...
		Label(emp1inf,text="Ms.ARUN (Head)",bg='white',fg="Grey",font='msserif 10').place(x=55,y=37)
		...
		b_frame.pack_propagate(False)
		b_frame.tkraise()
		nl = Label(b_frame,text='Made by Srinithi',fg='black',bg='gray91',font='msserif 8')
		nl.place(x=955,y=310)
		nl.tkraise()
